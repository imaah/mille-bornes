...
public class DefaultCarte extends Carte {
    public static final Carte DEFAULT = new DefaultCarte("DEFAUT", Categorie.DEFAULT, "assets/cartes/Null.jpg");
    public static final Carte VIDE = new DefaultCarte("DEFAUT", Categorie.DEFAULT, "assets/cartes/Vide.jpg");
